...
namespace CommandProcessor.Buffer.UnitTests
{
	...
	/// </summary>
	class SynchronousCommandProcessor : SynchronousCommandProcessor<Identifier, byte[], ICommand, ICommandWithResponse<Response>, Response>
	{
		/// <summary>
		...
		protected override byte[] PushCommandWithResponse(ICommandWithResponse<Identifier, byte[], Response> commandWithResponse)
		{
